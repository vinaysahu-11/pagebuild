...
const AdminDashboard = () => {
  ...
  const unreadChats = safeChats.filter((c) => c.sender === 'user').length;
  return (
    <div
    ...
    >
      ...
      >
        ...
        >
          ...
          <Link
            to="/admin/clients"
            className={`nav-item ${location.pathname === '/admin/clients' ? 'active' : ''}`}
          >
            <Users size={20} /> Clients & Projects
          </Link>
          <Link
            to="/admin/chats"
            className={`nav-item ${location.pathname === '/admin/chats' ? 'active' : ''}`}
            style={{
          ...
          <Link
            to="/admin/analytics"
            className={`nav-item ${location.pathname === '/admin/analytics' ? 'active' : ''}`}
          >
            <BarChart3 size={20} /> Analytics
          </Link>
          <Link
            to="/admin/marketing"
            className={`nav-item ${location.pathname === '/admin/marketing' ? 'active' : ''}`}
          >
          ...
          <Route
            ...
            element={
              <div className="animate-fade-in glass-panel">
                ...
                >
                  Admin settings, payment gateway configuration, and
      ...
      <div className="bottom-nav show-on-mobile">
        ...
        <Link
          to="/admin/clients"
          className={`bottom-nav-item ${location.pathname === '/admin/clients' ? 'active' : ''}`}
        >
          <Users size={20} />
          <span>Clients</span>
        </Link>
        <Link
          to="/admin/chats"
          className={`bottom-nav-item ${location.pathname === '/admin/chats' ? 'active' : ''}`}
          style={{
            position: 'relative',
          }}
        >
